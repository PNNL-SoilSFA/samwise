...
After this, copy `agent/.env.example` to `agent/.env` and set your API key and user settings there. The `.env` file is local configuration and must not be committed.
